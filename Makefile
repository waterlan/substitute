...
# operating system:  Linux 6.6.87.2-microsoft-standard-WSL2 x86_64 [ELF] (6.6.87)
# libc:	(6.35.0)
# binutils:	(238)
...
LOCAL_LIBRARIES = ./src/libsrc.a ./util/libutil.a ./objects/libobjects.a ./src/libsrc.a ./util/libutil.a ./objects/libobjects.a
...
install:: S
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  S $(DESTDIR)$(BINDIR)/S

install.man:: S.$(MANNEWSUFFIX)
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) S.$(MANNEWSUFFIX) $(DESTDIR)$(MANDIR)/S.$(MANSUFFIX)
